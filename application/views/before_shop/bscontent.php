<div class="py-3 bg-color bg-pattern">
      <div class="container">
        <div class="row">
          <div class="col-12">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card mb-4" style="width: auto">
                  <div class="badge badge-blue card-badge card-badge-left text-uppercase">New</div>
                  <!-- image -->
                  <img src="<?= base_url('assets');?>/img/Mask Group.png" alt="" />
                  <div class="card-body border-top">
                    <h5 class="card-title">Omron Arm Blood Pressure</h5>
                    <p class="card-text mb-2" style="color: #3682f4; font-size: 18px; font-family: 'Montserrat', sans-serif; font-weight: 700">Rp 3.450.000</p>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
              ...
              <div class="col-md-4">
                <div class="card mb-4" style="width: auto">
                  <div class="badge badge-blue card-badge card-badge-left text-uppercase">New</div>
                  <div class="badge badge-red card-badge card-badge-right text-uppercase">Sale</div>
                  <!-- image -->
                  <img src="<?= base_url('assets');?>/img/Mask Group.png" alt="" />
                  <div class="card-body border-top">
                    <h5 class="card-title">Omron Arm Blood Pressure</h5>
